...
<form action="vnpay.php" id="frmCreateOrder" method="post">        <div class="form-group">
            <label for="language">Loại hàng hóa </label>
            <select name="ordertype" id="ordertype" class="form-control">
                <option value="topup">Nạp tiền điện thoại</option>
                <option value="110000">Thanh toán hóa đơn</option>
...
Thanh toan don hang thoi gian: 2022-03-05 15:30:29</textarea>
        </div>
    <div class="form-group">
...
<input name="__RequestVerificationToken" type="hidden" value="-Xxwi2l_DTC1QLwnCwRSuk2QSsTbn0IAQ4-Y6RPsBUIKruIqGCPctgmw_Z2vIx7msz2BoQCcuTK3nUzrhxWYWesXjFwD8tUSjX9cp4ilopU1" /></form>
</div>
<p>
    &nbsp;
</p>
